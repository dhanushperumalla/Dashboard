...
new Chart(ctx2,{
    ...
    new Chart(ctx3,{
        ...
        document.getElementById("light-mode").addEventListener("click",function(){
            ...
            document.getElementById("main-content").style.color="#161616";
            document.getElementById("header").style.color="#161616";
        ...
        //     document.getElementById("main-content").style.backgroundColor="#161616";
        ...
        //     DocumentTimeline.getElementById("header").style.color="white";
        //     let boxes = document.getElementsByClassName("box");
    ...
    document.getElementById("sidebar").style.color = "white";
    document.getElementById("main-content").style.color = "white";
    document.getElementById("header").style.color = "white"; // Fix here
    let boxes = document.getElementsByClassName("box");
